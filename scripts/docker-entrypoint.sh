...
ASSETS_CONTAINER_PATH="/opt/remnasale/assets"
ASSETS_DEFAULT_PATH="/opt/remnasale/assets.default"
...
if [ "$UVICORN_RELOAD_ENABLED" = "true" ]; then
    ...
    UVICORN_RELOAD_ARGS="--reload --reload-dir /opt/remnasale/src --reload-dir /opt/remnasale/assets --reload-include *.ftl"
else
